										...
										<div class="row">
											<div class="col-md-8">
												...
												<div class="m-portlet m-portlet--tab">
													...
													<!--begin::Form-->
													<?php echo form_open('Calculo/create', array('method'=>'POST', 'class' => 'm-form m-form--label-align-right')); ?>
													<!--<form class="m-form m-form--fit m-form--label-align-right">-->
														...
														<div class="m-portlet__body">
															...
															<div class="form-group m-form__group row">
																<label for="example-search-input"  class="col-lg-8 col-form-label">1. ¿A cuánto alcanza tus ingresos liquidos mensuales? (Bs.)</label>
																<div class="col-lg-3">
															...
															<div class="form-group m-form__group row" 	id="hidden_pago_ef">
																<label for="example-email-input" class="col-lg-8 col-form-label">3.1 ¿Cuánto pagas mensualmente por tus prestamos en otras entidades financieras?</label>
																<div class="col-lg-3">
															...
															<div class="form-group m-form__group row" id="hidden_pago_m">
																<label for="example-url-input" class="col-lg-8 col-form-label">4.1 ¿Cuánto pagas mensualmente de alquiler?</label>
																<div class="col-lg-3">
																	<input class="form-control m-input m-input--air m-input--pill" type="number" value="" id="example-url-input" name="pago_alquiler" >
																</div>
															</div>
															<div class="form-group m-form__group row">
																<label for="example-tel-input" class="col-lg-8 col-form-label">5. ¿Por cuántos miembros esta compuesto la unidad familiar?</label>
																<div class="col-lg-3">
															...
															<div class="form-group m-form__group row" id="hidden_div">
																<label for="example-password-input" class="col-lg-8 col-form-label">6.1. ¿A cuanto alcanza su aporte propio? (AHORRO EN EFECTIVO Y/O ANTICRETICO) ($us)</label>
																<div class="col-lg-3">
